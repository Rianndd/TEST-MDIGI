        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Rekening</h3>
                    <p class="text-subtitle text-muted">Edit Rekening.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-vertical" action="{{ route('rekening.update', $rekening->rekening_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control mt-2"
                                                name="kode_rekening" value="{{ $rekening->kode_rekening }}" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical" class="form-control mt-2"
                                                name="nama_rekening" value="{{ $rekening->nama_rekening }}" required>
                                        </div>
                                    </div>
